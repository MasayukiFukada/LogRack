defmodule LogLacWeb.AtmosphericPressureControllerTest do
  ...
  describe "create atmospheric_pressure" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      conn =
        post(conn, Routes.atmospheric_pressure_path(conn, :create),
          atmospheric_pressure: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.atmospheric_pressure_path(conn, :create),
          atmospheric_pressure: @invalid_attrs
        )
  ...
  describe "edit atmospheric_pressure" do
    ...
    test "renders form for editing chosen atmospheric_pressure", %{
      conn: conn,
  ...
  describe "update atmospheric_pressure" do
    ...
    test "redirects when data is valid", %{conn: conn, atmospheric_pressure: atmospheric_pressure} do
      conn =
        put(conn, Routes.atmospheric_pressure_path(conn, :update, atmospheric_pressure),
          atmospheric_pressure: @update_attrs
        )

      assert redirected_to(conn) ==
               Routes.atmospheric_pressure_path(conn, :show, atmospheric_pressure)
  ...
  describe "delete atmospheric_pressure" do
    ...
    test "deletes chosen atmospheric_pressure", %{
      conn: conn,
      atmospheric_pressure: atmospheric_pressure
    } do
